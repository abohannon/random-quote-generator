$(document).ready(() => {
  ...
  $('.quote-btn').on('click', () => {
    const quotesList = $.getJSON(
      'https://gist.githubusercontent.com/abohannon/a0187309c729f04d571b74cfca893dac/raw/e680af4b71494e520c4d6f8bfaa2e98142e728fe/trump-quote2',
      (json) => {
        ...
        const color = Math.floor(Math.random() * colors.length); // Randomize colors from colors array at top
